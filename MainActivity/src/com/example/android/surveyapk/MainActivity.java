           ...
           btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            {   // RED button on click ??                            	
                            	...
                            	if(subjectName.getText().toString().contentEquals(""))
                            	{
                        			...
                        			Toast toast = Toast.makeText(v.getContext(),"Bitte geben Sie einen vollständigen Namen (anonymisiert) ! " , Toast.LENGTH_LONG);
                                ...
                                new DirectoryChooserDialog(MainActivity.this, 
                                    new DirectoryChooserDialog.ChosenDirectoryListener() 
                                    {
                                        ...
                                        public void onChosenDir(String chosenDir) 
                                        {
                                         ...
                                         // BORIS' dada1 ### START ### START ### START ### START 
                                         ...
                                         // data1.dign=subjectDign.getText().toString(); //## Nr1
                                         //*************************************************************
                                         //spin = (Spinner) findViewById(R.id.commentIs); //commentIs;
                                         //----- --- --- --- --- --- --- -- -- -- -- -- -- --
                                         strCommentIs = edCommentIs.getText().toString();   
                                         strName = subjectName.getText().toString();   
                                    	 //strDign = subjectDign.getText().toString(); // Nr1
                                    	 strDign = spinDiagnoseIs.getSelectedItem().toString(); //## Nr2
                                         data1.dign=spinDiagnoseIs.getSelectedItem().toString(); //## Nr2

                                         //####
                                         strDoseIs = spinDoseIs.getSelectedItem().toString();   
                                         strGenderIs = spinGender.getSelectedItem().toString();   
                                         strStudyIs = spinStudyIs.getSelectedItem().toString(); 
                                         strGroupIs = spinGroupIs.getSelectedItem().toString(); 
                                         strPharmaIs = spinPharmaIs.getSelectedItem().toString(); 
                                         //#
                                         //##
                                         //#####
                                         strDiagnoseIs = spinDiagnoseIs.getSelectedItem().toString(); 
                                         //#####
                                         //##
                                         //#                                        
                                         strSubjectIs = spinSubjectIs.getSelectedItem().toString(); 
                                         strTreatmentIs = spinTreatmentIs.getSelectedItem().toString(); 
                                         strAgainIs = spinAgainIs.getSelectedItem().toString();                                          
                                         strAgainIs = spinAgainIs.getSelectedItem().toString(); 
                                         strAgeIs = spinAgeIs.getSelectedItem().toString(); 
                                         intAgeIs = Integer.parseInt(strAgeIs); 

                                         Log.w("Seide", "Dil gen:strGenderI "+strGenderIs);
                                         Log.w("Seide", "Dil gen:strStudyIs "+strStudyIs);
                                         Log.w("Seide", "Dil gen:strSubject "+strSubjectIs);
                                         Log.w("Seide", "Dil gen:strTreatme "+strTreatmentIs);
                                         Log.w("Seide", "Dil gen:strAgainIs "+strAgainIs);
                                         Log.w("Seide", "Dil gen:strComment "+strCommentIs);
                                         Log.w("Seide", "Dil gen:strAgeIs:"+strAgeIs+"XX");
                                         Log.w("Seide", "Dil gen:intAgeIs:"+intAgeIs+"XX");
                                         
                                         Log.w("Seide", "DilY gen:strName:"+strName+" YY");
                                         Log.w("Seide", "DilY gen:strDign:"+strDign+" YY");
                                         Log.w("Seide", "DilY gen:strPharmaIs:"+strPharmaIs+" YY");
                                         Log.w("Seide", "DilY gen:strDoseIs:"+strDoseIs+" YY");

                                 		 Log.w("ANGARA", "  ANGARA0 MainActivity.alphaName: "+MainActivity.alphaName );
                                		 Log.w("ANGARA", "  ANGARA0 MainActivity.alphaVal: "+MainActivity.alphaVal );
                                         //----- --- --- --- --- --- --- -- -- -- -- -- -- --
		        ...
		        btn1.setOnClickListener(new View.OnClickListener() {
		            ...
		            public void onClick(View v) {
		            	...
		            	Spinner sp1 = (Spinner)findViewById(R.id.diagnoseIs);  sp1.setSelection(0);
		            	Spinner sp2 = (Spinner)findViewById(R.id.genderIs);  sp2.setSelection(0);// genderIs
		            	Spinner sp3 = (Spinner)findViewById(R.id.ageIs);  sp3.setSelection(0);// ageIs
		            	Spinner sp4 = (Spinner)findViewById(R.id.studyIs);  sp4.setSelection(0);// studyIs
		            	Spinner sp5 = (Spinner)findViewById(R.id.groupIs);  sp5.setSelection(0);// groupIs
		            	Spinner sp6 = (Spinner)findViewById(R.id.subjectIs);  sp6.setSelection(0);// subjectIs
		            	Spinner sp7 = (Spinner)findViewById(R.id.againIs);  sp7.setSelection(0);// againIs
		            	Spinner sp8 = (Spinner)findViewById(R.id.treatmentIs);  sp8.setSelection(0);// treatmentIs
		            	Spinner sp9 = (Spinner)findViewById(R.id.pharmaIs);  sp9.setSelection(0);// pharmaIs
		            	Spinner sp10 = (Spinner)findViewById(R.id.doseIs);  sp10.setSelection(0);// doseIs
